...
**Critical:** Complete Stage 1 (spec compliance) BEFORE Stage 2 (code quality). Never review code
quality for functionality that doesn't meet the specification.
...
> "The implementer finished suspiciously quickly. Their report may be incomplete, inaccurate, or
> optimistic."
