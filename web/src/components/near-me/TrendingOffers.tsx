  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <a href="#" className="text-[12px] text-accent font-medium hover:underline">See All</a>
      </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                {offer.bioLink && (
                  <div className="flex items-center gap-1 mt-0.5">
                    ...
                    <a href={`https://${offer.bioLink}`} className="text-[11px] text-accent font-medium hover:underline truncate" onClick={e => e.stopPropagation()}>
                      {offer.bioLink}
                    </a>
                  </div>
                )}
