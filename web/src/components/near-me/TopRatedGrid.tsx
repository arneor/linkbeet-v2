  ...
  return (
    <>
      <div className="flex items-center justify-between mb-4 mt-2">
        ...
        <a
          href="#"
          className="text-[14px] text-accent font-medium hover:underline flex items-center gap-1"
        >
          See All
          <svg
            viewBox="0 0 24 24"
        ...
        {items.map((item) => (
          ...
          >
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${item.avatarColor}aa 0%, ${item.avatarColor} 100%)`,
              }}
            >
            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mt-auto">
                {item.tags.map((t) => (
                  <span
                    key={t}
                    className="px-2.5 py-1 text-[12px] font-medium text-slate-600 bg-slate-100 rounded-[8px]"
                  >
                    {t}
                  </span>
                ))}
