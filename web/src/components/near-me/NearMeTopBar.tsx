      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-[240px] bg-white border border-slate-200 rounded-full py-[7px] pl-9 pr-4 text-[13px] text-slate-900 placeholder:text-slate-400 outline-none focus:border-accent/40 focus:ring-4 focus:ring-accent/5 transition-all"
          />
        </div>
