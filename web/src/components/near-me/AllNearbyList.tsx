              ...
              <div className="flex flex-col items-start gap-1 overflow-hidden pr-4">
                ...
                {item.bioLink && (
                  <div className="flex items-center gap-1 w-full">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-[14px] h-[14px] text-accent shrink-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  {item.tags?.map((t: string) => (
                    <span key={t} className="px-2 py-0.5 text-[11px] font-medium bg-slate-100 text-slate-600 rounded-[6px]">
                      {t}
                    </span>
                  ))}
                  {item.badge && (
